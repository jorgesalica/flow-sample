...
history when they remain useful. Do not add package-local backlogs or a second PR
template; GitHub issues and `.github/pull_request_template.md` own those contracts.

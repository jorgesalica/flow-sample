...
> **Purpose**: This document describes the _capabilities_ of the Lyrics Flow — intentional lenses for enriching your music collection with the words behind the sound.

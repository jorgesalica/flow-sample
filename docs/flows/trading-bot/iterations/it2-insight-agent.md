...
2. **Glass Box AI**: Show the user exactly *what* data the AI analyzed. Build trust.
...
- **Relevance**: Tip must relate to the *current* regime (e.g., "In this mean-reverting regime, look for entries at boundaries", NOT "Always trend follow").

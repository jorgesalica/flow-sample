...
- **Spotify Flow UI:** Run `npm run spotify:server` to serve a minimal HTML interface that can trigger the export/enrich flow and explore the resulting tracks without leaving the browser.

...
export const tradingDb: Database.Database = createDatabase('trading.db');
...
export const upsertCandle: Database.Statement = tradingDb.prepare(`
...
export const getLastNCandles: Database.Statement = tradingDb.prepare(`
  SELECT * FROM candles 
...
export const getLastCandle: Database.Statement = tradingDb.prepare(`
  SELECT * FROM candles 
  WHERE symbol = ? AND interval = ?
  ORDER BY open_time DESC 
  LIMIT 1
...
export const getLastNFractalNodes: Database.Statement = tradingDb.prepare(`
...
export const insertAdvisorLog: Database.Statement = tradingDb.prepare(`
...
export const getLatestAdvisorLog: Database.Statement = tradingDb.prepare(`

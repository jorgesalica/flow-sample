...
describe('getRecentFractals', () => {
  ...
  it('returns all if fewer than count', () => {
    const fractals: FractalNode[] = [{ type: 'high', price: 100, candleOpenTime: 1, index: 1 }];
...
describe('calculateTouchCounts', () => {
  it('counts touches within tolerance', () => {
    const fractals: FractalNode[] = [{ type: 'high', price: 100, candleOpenTime: 1, index: 0 }];
    const candles: Candle[] = [
  ...
  it('returns 0 touches when no candles are close', () => {
    const fractals: FractalNode[] = [{ type: 'high', price: 200, candleOpenTime: 1, index: 0 }];
    const candles: Candle[] = Array.from({ length: 10 }, (_, i) => candle(i, 95, 100, 90, 95));

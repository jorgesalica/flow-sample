...
export const meaningAnnotationSchema = z.object({
  ...
  detail: z
    .string()
    .describe('Detailed explanation of the textual meaning context for this specific phrase'),
  context: z.string().describe('The broad theme this relates to'),
});

export const textAnnotationSchema = z.discriminatedUnion('layerId', [meaningAnnotationSchema]);
